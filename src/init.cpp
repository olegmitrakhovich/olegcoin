...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: olegcoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: olegcoind.pid)") + "\n";
    ...
    strUsage += "  -loadblock=<file>      " + _("Imports blocks from external olg000?.dat file") + "\n";
